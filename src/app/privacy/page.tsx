    ...
    <div className="page-content site-shell">
      <div className="content-layout">
        <article className="prose">
          ...
          <p>시행일: 2026년 7월 23일 · 최종 검토일: 2026년 7월 24일</p>

          <h2>1. 사용자가 선택한 이미지</h2>
          <p>선택한 사진, 이미지 Blob, 얼굴 후보 좌표와 발견한 이미지 메타데이터는 픽셀핏의 업로드 서버로 보내지 않습니다. 이미지 작업은 현재 탭의 브라우저 메모리에서 실행됩니다.</p>
          ...
          <h2>6. 문의</h2>
          <p>개인정보 관련 문의는 <a href={brand.contactHref}>{brand.contactLabel}</a>로 접수할 수 있습니다. 공개 문의에는 원본 사진이나 신분증 이미지를 첨부하지 마세요.</p>
        </article>
